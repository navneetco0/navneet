  ...
  return (
    <Flex mt="30px" justifyContent={'space-evenly'} flexWrap="wrap" gap="20px" >
      {things.map((Element, index) => (
        <Box flexDir={'column'} p="20px" key={index}  textAlign={'center'} maxWidth="300px" h="300px" bg="#f8f8f8" boxShadow={'rgba(0, 0, 0, 0.5) 0px 5px 10px 0px'} borderRadius="10px" zIndex="2">
           <Circle bg="#6d83f2" m={'auto'} size="100px" >
            <Box h="40px" color={'white'} >{Element.icon}</Box>
           </Circle>
           <Text fontFamily={'montserrat'} fontSize="21px" color="#6d83f2" m="20px 0px">{Element.heading}</Text>
